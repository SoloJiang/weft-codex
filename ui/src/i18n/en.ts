const en = {
  ...
  "entries.search": "Search workspace",
  "entries.searchLabel": "Search this workspace",
  "entries.searchPlaceholder": "Issues, tasks, docs…",
  "entries.noMatches": "Nothing matches",
  "entries.inbox": "Inbox",
  ...
  "entries.kind.artifact": "Doc",
  "entries.kind.thread": "Chat",
  ...
  "kanban.issueProgress": "{done}/{total} done",
  "lead.startFailed": "Chat could not be opened",
  "lead.resumeFailed": "Chat could not be recovered",
  "lead.turnError": "Chat stopped with an error",
  "lead.failed": "Chat needs attention",
  ...
  "dir.startFailed": "The worker could not start",
  "dir.resumeFailed": "The task chat could not be recovered",
  "dir.turnFailed": "The last turn failed",
  "dir.quotaExceeded": "Usage limit reached",
  "dir.undelivered": "A message could not be delivered",
