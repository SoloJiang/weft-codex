...
const zh = {
  ...
  "surface.popoverTitle": "会话",
  "surface.inspectorTitle": "Issue 详情",
  "nav.primary": "工作区导航",
  "nav.kanban": "看板",
  "nav.repos": "仓库",
  ...
  "popover.close": "关闭会话面板",
  "popover.noThread": "当前不在任何会话中。",
  "popover.notWeft": "当前会话不属于任何 issue。",
  "popover.details": "详情",
  "popover.openDetails": "打开 issue 详情",
  "workspace.label": "工作区",
